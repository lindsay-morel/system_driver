 ...
 *
 ******************************************************************************/
#ifndef MEMX_CASCADE_H_
#define MEMX_CASCADE_H_
 ...
 * case worker number is increased, 'memx_cascade_set_stream_enable' is required
 ...
 * function must be called after 'memx_cascade_set_ifmap_size' since it will
